<script lang="ts">
	...
	const faqs = [
		...
		},
		{
			...
			a: 'بله. برنامه بر اساس چهار بخش آزمون — شنیدن، خواندن، نوشتن و صحبت — پیش می‌رود و آمادگی‌ات را در هر بخش جداگانه نشان می‌دهد.'
		},
		{
			q: 'چقدر باید هر روز وقت بگذارم؟',
			a: 'با سرعت خودت پیش برو. هر جا لازم بود دوباره گوش کن و جمله‌ها را تمرین کن.'
		},
		{
