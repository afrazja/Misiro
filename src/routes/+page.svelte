...
<style>
	...
	.grad-text {
		background: linear-gradient(90deg, #C75B39, #D9805F);
	...
	.cta-btn.primary {
		background: linear-gradient(90deg, #C75B39, #D9805F);
		color: white;
		box-shadow: 0 8px 32px rgba(199, 91, 57, 0.4);
	}

	.cta-btn.primary:hover {
		transform: translateY(-3px) scale(1.03);
		box-shadow: 0 16px 48px rgba(199, 91, 57, 0.55);
	}

	.cta-btn.ghost {
		background: transparent;
		color: rgba(43, 42, 40, 0.8);
		border: 2px solid rgba(43, 42, 40, 0.25);
	}

	.cta-btn.ghost:hover {
		border-color: rgba(43, 42, 40, 0.6);
		color: #2B2A28;
	...
	.btn.btn-primary:hover {
		...
		box-shadow: 0 8px 24px rgba(199, 91, 57, 0.5);
	}
	...
	.confirm-toast {
		...
		background: linear-gradient(135deg, #5A7D5A, #4F7355);
		color: white;
		padding: 16px 32px;
		border-radius: 14px;
		font-size: 1rem;
		font-weight: 600;
		box-shadow: 0 10px 40px rgba(90, 125, 90, 0.4);
		z-index: 2000;
	...
	.auth-modal {
		background: linear-gradient(145deg, #FAF6EF, #F3EAD9);
		border-radius: 24px;
	...
	.navbar.scrolled {
		...
		border-bottom: 1px solid rgba(43, 42, 40, 0.07);
		padding: 13px 48px;
	...
	.hero-badge {
		...
		border: 1px solid rgba(199, 91, 57, 0.38);
		border-radius: 50px;
		font-size: 0.88rem;
		font-weight: 600;
		color: #9a4b2f;
	...
	.phone-frame {
		...
		background: #ffffff;
		border-radius: 40px;
		border: 8px solid rgba(43, 42, 40, 0.09);
		box-shadow:
			0 50px 100px rgba(0, 0, 0, 0.55),
			0 0 0 1px rgba(43, 42, 40, 0.04);
		overflow: hidden;
	...
	/* ── Stats strip ──────────────────────────────────── */
	.stats-strip {
		background: rgba(43, 42, 40, 0.035);
	...
	.feat-card {
		background: rgba(43, 42, 40, 0.045);
		border: 1px solid rgba(43, 42, 40, 0.08);
		border-radius: 20px;
		padding: 30px 26px;
	...
	.j-dot.green {
		background: #5A7D5A;
		box-shadow: 0 0 10px rgba(90, 125, 90, 0.5);
	}
	...
	.j-dot.purple {
		background: #C99A3B;
		box-shadow: 0 0 10px rgba(201, 154, 59, 0.5);
	}
	...
	.audience-card:hover {
		transform: translateY(-6px);
		border-color: rgba(90, 125, 90, 0.35);
		box-shadow: 0 20px 50px rgba(0, 0, 0, 0.3);
	}
