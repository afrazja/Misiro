...
describe('removed word tiles', () => {
 it('does not turn worked example sentences into tile exercises', () => {
  expect(buildChecks([{german:'Heute gehe ich ins Kino.', en:'Today I go to the cinema.'}], 'en')).toEqual([]);
 });
});
